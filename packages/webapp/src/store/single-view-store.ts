...
export interface SingleViewStore {
  ...
  setShowQuickTagging(show: boolean): void
}
...
>(  persist((set) => ({
  ...
  setShowQuickTagging: (show: boolean) => set((state: SingleViewStore) => ({...state, showQuickTagging: show})),
}), {
